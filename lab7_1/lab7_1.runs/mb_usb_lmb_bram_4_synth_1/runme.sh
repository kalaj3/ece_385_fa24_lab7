...
HD_PWD='C:/Users/jkali/ece385/lab7/lab7_1/lab7_1.runs/mb_usb_lmb_bram_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_usb_lmb_bram_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_usb_lmb_bram_4.tcl
