...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../lab7_1.gen/sources_1/bd/mb_usb/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../lab7_1.gen/sources_1/bd/mb_usb/ipshared/7698" \
       +incdir+"../../../../lab7_1.gen/sources_1/bd/mb_usb/ipshared/ec67/hdl" \
       +incdir+"../../../../lab7_1.gen/sources_1/bd/mb_usb/ipshared/7698" \
       -input simulate.do
}
